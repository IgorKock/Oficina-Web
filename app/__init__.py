...
# Importamos ProgrammingError especificamente
...
def create_app():
    ...
    DB_PASSWORD = os.environ.get('DB_PASSWORD', '123') # CERTIFIQUE-SE QUE ESTA SENHA ESTÁ CORRETA E É A MESMA DO MARIA_DB
